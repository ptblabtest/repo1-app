...
export const ReportFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ReportSelect, Prisma.ReportSelect> = z.object({
...
export const ReportFindFirstOrThrowSchema: z.ZodType<Prisma.ReportFindFirstOrThrowArgs, Prisma.ReportFindFirstOrThrowArgs> = z.object({ select: ReportFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ReportIncludeObjectSchema.optional()), orderBy: z.union([ReportOrderByWithRelationInputObjectSchema, ReportOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportWhereInputObjectSchema.optional(), cursor: ReportWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportScalarFieldEnumSchema, ReportScalarFieldEnumSchema.array()]).optional() }).strict();
