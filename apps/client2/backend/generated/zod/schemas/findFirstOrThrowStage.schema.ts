...
export const StageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StageSelect, Prisma.StageSelect> = z.object({
...
export const StageFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    stageTypeId: z.boolean().optional(),
    comment: z.boolean().optional(),
    createdById: z.boolean().optional(),
...
export const StageFindFirstOrThrowSchema: z.ZodType<Prisma.StageFindFirstOrThrowArgs, Prisma.StageFindFirstOrThrowArgs> = z.object({ select: StageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StageIncludeObjectSchema.optional()), orderBy: z.union([StageOrderByWithRelationInputObjectSchema, StageOrderByWithRelationInputObjectSchema.array()]).optional(), where: StageWhereInputObjectSchema.optional(), cursor: StageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StageScalarFieldEnumSchema, StageScalarFieldEnumSchema.array()]).optional() }).strict();

export const StageFindFirstOrThrowZodSchema = z.object({ select: StageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StageIncludeObjectSchema.optional()), orderBy: z.union([StageOrderByWithRelationInputObjectSchema, StageOrderByWithRelationInputObjectSchema.array()]).optional(), where: StageWhereInputObjectSchema.optional(), cursor: StageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StageScalarFieldEnumSchema, StageScalarFieldEnumSchema.array()]).optional() }).strict();