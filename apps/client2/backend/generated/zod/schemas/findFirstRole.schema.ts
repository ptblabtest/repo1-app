...
export const RoleFindFirstSelectSchema: z.ZodType<Prisma.RoleSelect, Prisma.RoleSelect> = z.object({
...
export const RoleFindFirstSchema: z.ZodType<Prisma.RoleFindFirstArgs, Prisma.RoleFindFirstArgs> = z.object({ select: RoleFindFirstSelectSchema.optional(), include: z.lazy(() => RoleIncludeObjectSchema.optional()), orderBy: z.union([RoleOrderByWithRelationInputObjectSchema, RoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoleWhereInputObjectSchema.optional(), cursor: RoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoleScalarFieldEnumSchema, RoleScalarFieldEnumSchema.array()]).optional() }).strict();
