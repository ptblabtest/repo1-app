...
export const StageTypeFindUniqueSchema = z.object({ select: StageTypeSelectObjectSchema.optional(), include: StageTypeIncludeObjectSchema.optional(), where: StageTypeWhereUniqueInputObjectSchema })