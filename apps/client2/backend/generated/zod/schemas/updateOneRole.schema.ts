...
export const RoleUpdateOneSchema = z.object({ select: RoleSelectObjectSchema.optional(), include: RoleIncludeObjectSchema.optional(), data: z.union([RoleUpdateInputObjectSchema, RoleUncheckedUpdateInputObjectSchema]), where: RoleWhereUniqueInputObjectSchema  })