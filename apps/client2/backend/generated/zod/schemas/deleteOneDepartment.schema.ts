...
export const DepartmentDeleteOneSchema = z.object({ select: DepartmentSelectObjectSchema.optional(), include: DepartmentIncludeObjectSchema.optional(), where: DepartmentWhereUniqueInputObjectSchema  })