...
export const PermissionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PermissionSelect, Prisma.PermissionSelect> = z.object({
...
export const PermissionFindFirstOrThrowSchema: z.ZodType<Prisma.PermissionFindFirstOrThrowArgs, Prisma.PermissionFindFirstOrThrowArgs> = z.object({ select: PermissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PermissionIncludeObjectSchema.optional()), orderBy: z.union([PermissionOrderByWithRelationInputObjectSchema, PermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PermissionWhereInputObjectSchema.optional(), cursor: PermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PermissionScalarFieldEnumSchema, PermissionScalarFieldEnumSchema.array()]).optional() }).strict();

export const PermissionFindFirstOrThrowZodSchema = z.object({ select: PermissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PermissionIncludeObjectSchema.optional()), orderBy: z.union([PermissionOrderByWithRelationInputObjectSchema, PermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PermissionWhereInputObjectSchema.optional(), cursor: PermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PermissionScalarFieldEnumSchema, PermissionScalarFieldEnumSchema.array()]).optional() }).strict();