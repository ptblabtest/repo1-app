...
export const FileUpsertSchema = z.object({ select: FileSelectObjectSchema.optional(), include: FileIncludeObjectSchema.optional(), where: FileWhereUniqueInputObjectSchema, create: z.union([ FileCreateInputObjectSchema, FileUncheckedCreateInputObjectSchema ]), update: z.union([ FileUpdateInputObjectSchema, FileUncheckedUpdateInputObjectSchema ])  })