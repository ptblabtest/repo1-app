...
export const FileUpdateOneSchema = z.object({ select: FileSelectObjectSchema.optional(), include: FileIncludeObjectSchema.optional(), data: z.union([FileUpdateInputObjectSchema, FileUncheckedUpdateInputObjectSchema]), where: FileWhereUniqueInputObjectSchema  })