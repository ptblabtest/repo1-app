...
export const ProfileCreateOneSchema = z.object({ select: ProfileSelectObjectSchema.optional(), include: ProfileIncludeObjectSchema.optional(), data: z.union([ProfileCreateInputObjectSchema, ProfileUncheckedCreateInputObjectSchema])  })