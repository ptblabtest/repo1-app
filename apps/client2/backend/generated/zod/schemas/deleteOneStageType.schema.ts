...
export const StageTypeDeleteOneSchema = z.object({ select: StageTypeSelectObjectSchema.optional(), include: StageTypeIncludeObjectSchema.optional(), where: StageTypeWhereUniqueInputObjectSchema  })