...
export const UserPermissionFindFirstSelectSchema: z.ZodType<Prisma.UserPermissionSelect, Prisma.UserPermissionSelect> = z.object({
...
export const UserPermissionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    permissionId: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const UserPermissionFindFirstSchema: z.ZodType<Prisma.UserPermissionFindFirstArgs, Prisma.UserPermissionFindFirstArgs> = z.object({ select: UserPermissionFindFirstSelectSchema.optional(), include: z.lazy(() => UserPermissionIncludeObjectSchema.optional()), orderBy: z.union([UserPermissionOrderByWithRelationInputObjectSchema, UserPermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPermissionWhereInputObjectSchema.optional(), cursor: UserPermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPermissionScalarFieldEnumSchema, UserPermissionScalarFieldEnumSchema.array()]).optional() }).strict();

export const UserPermissionFindFirstZodSchema = z.object({ select: UserPermissionFindFirstSelectSchema.optional(), include: z.lazy(() => UserPermissionIncludeObjectSchema.optional()), orderBy: z.union([UserPermissionOrderByWithRelationInputObjectSchema, UserPermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPermissionWhereInputObjectSchema.optional(), cursor: UserPermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPermissionScalarFieldEnumSchema, UserPermissionScalarFieldEnumSchema.array()]).optional() }).strict();