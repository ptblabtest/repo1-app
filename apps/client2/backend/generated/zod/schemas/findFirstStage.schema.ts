...
export const StageFindFirstSelectSchema: z.ZodType<Prisma.StageSelect, Prisma.StageSelect> = z.object({
...
export const StageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    stageTypeId: z.boolean().optional(),
    comment: z.boolean().optional(),
    createdById: z.boolean().optional(),
