...
export const ReportCategoryFindUniqueOrThrowSchema = z.object({ select: ReportCategorySelectObjectSchema.optional(), include: ReportCategoryIncludeObjectSchema.optional(), where: ReportCategoryWhereUniqueInputObjectSchema })