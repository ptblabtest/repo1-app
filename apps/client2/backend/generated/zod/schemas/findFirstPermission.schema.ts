...
export const PermissionFindFirstSelectSchema: z.ZodType<Prisma.PermissionSelect, Prisma.PermissionSelect> = z.object({
...
export const PermissionFindFirstSchema: z.ZodType<Prisma.PermissionFindFirstArgs, Prisma.PermissionFindFirstArgs> = z.object({ select: PermissionFindFirstSelectSchema.optional(), include: z.lazy(() => PermissionIncludeObjectSchema.optional()), orderBy: z.union([PermissionOrderByWithRelationInputObjectSchema, PermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PermissionWhereInputObjectSchema.optional(), cursor: PermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PermissionScalarFieldEnumSchema, PermissionScalarFieldEnumSchema.array()]).optional() }).strict();

export const PermissionFindFirstZodSchema = z.object({ select: PermissionFindFirstSelectSchema.optional(), include: z.lazy(() => PermissionIncludeObjectSchema.optional()), orderBy: z.union([PermissionOrderByWithRelationInputObjectSchema, PermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PermissionWhereInputObjectSchema.optional(), cursor: PermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PermissionScalarFieldEnumSchema, PermissionScalarFieldEnumSchema.array()]).optional() }).strict();