...
export const ReportCategoryUncheckedCreateInputObjectSchema: z.ZodType<Prisma.ReportCategoryUncheckedCreateInput, Prisma.ReportCategoryUncheckedCreateInput> = z.object({
...
export const ReportCategoryUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  code: z.string(),
  parentId: z.string().nullish(),
