...
export const UserUncheckedCreateWithoutOrganizationInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutOrganizationInput, Prisma.UserUncheckedCreateWithoutOrganizationInput> = z.object({
...
export const UserUncheckedCreateWithoutOrganizationInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
