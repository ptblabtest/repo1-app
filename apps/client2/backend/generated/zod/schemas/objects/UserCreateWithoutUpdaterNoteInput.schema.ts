...
export const UserCreateWithoutUpdaterNoteInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterNoteInput, Prisma.UserCreateWithoutUpdaterNoteInput> = z.object({
...
export const UserCreateWithoutUpdaterNoteInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
