...
export const UserCreateWithoutUpdaterDepartmentInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterDepartmentInput, Prisma.UserCreateWithoutUpdaterDepartmentInput> = z.object({
...
export const UserCreateWithoutUpdaterDepartmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
