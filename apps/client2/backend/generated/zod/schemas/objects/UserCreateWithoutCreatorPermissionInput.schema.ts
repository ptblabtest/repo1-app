...
export const UserCreateWithoutCreatorPermissionInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorPermissionInput, Prisma.UserCreateWithoutCreatorPermissionInput> = z.object({
...
export const UserCreateWithoutCreatorPermissionInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
