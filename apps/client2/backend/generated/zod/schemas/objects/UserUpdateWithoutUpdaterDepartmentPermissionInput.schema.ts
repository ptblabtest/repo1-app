...
import { DepartmentUpdateManyWithoutCreatedByNestedInputObjectSchema } from './DepartmentUpdateManyWithoutCreatedByNestedInput.schema';
...
export const UserUpdateWithoutUpdaterDepartmentPermissionInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutUpdaterDepartmentPermissionInput, Prisma.UserUpdateWithoutUpdaterDepartmentPermissionInput> = z.object({
  ...
  CreatorDepartment: z.lazy(() => DepartmentUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(),
...
export const UserUpdateWithoutUpdaterDepartmentPermissionInputObjectZodSchema = z.object({
  username: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  password: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  status: z.union([UserStatusSchema, z.lazy(() => EnumUserStatusFieldUpdateOperationsInputObjectSchema)]).optional(),
  department: z.lazy(() => DepartmentUpdateOneWithoutUsersNestedInputObjectSchema).optional(),
