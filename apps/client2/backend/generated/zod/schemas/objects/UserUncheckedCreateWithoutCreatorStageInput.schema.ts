...
export const UserUncheckedCreateWithoutCreatorStageInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreatorStageInput, Prisma.UserUncheckedCreateWithoutCreatorStageInput> = z.object({
...
export const UserUncheckedCreateWithoutCreatorStageInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
