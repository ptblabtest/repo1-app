...
export const UserCreateWithoutOrganizationInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutOrganizationInput, Prisma.UserCreateWithoutOrganizationInput> = z.object({
...
export const UserCreateWithoutOrganizationInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
