...
export const UserUncheckedUpdateManyWithoutOrganizationNestedInputObjectSchema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutOrganizationNestedInput, Prisma.UserUncheckedUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([z.lazy(() => UserUpsertWithWhereUniqueWithoutOrganizationInputObjectSchema), z.lazy(() => UserUpsertWithWhereUniqueWithoutOrganizationInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => UserUpdateWithWhereUniqueWithoutOrganizationInputObjectSchema), z.lazy(() => UserUpdateWithWhereUniqueWithoutOrganizationInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => UserUpdateManyWithWhereWithoutOrganizationInputObjectSchema), z.lazy(() => UserUpdateManyWithWhereWithoutOrganizationInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => UserScalarWhereInputObjectSchema), z.lazy(() => UserScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const UserUncheckedUpdateManyWithoutOrganizationNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => UserCreateWithoutOrganizationInputObjectSchema), z.lazy(() => UserCreateWithoutOrganizationInputObjectSchema).array(), z.lazy(() => UserUncheckedCreateWithoutOrganizationInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutOrganizationInputObjectSchema).array()]).optional(),
  connectOrCreate: z.union([z.lazy(() => UserCreateOrConnectWithoutOrganizationInputObjectSchema), z.lazy(() => UserCreateOrConnectWithoutOrganizationInputObjectSchema).array()]).optional(),
  upsert: z.union([z.lazy(() => UserUpsertWithWhereUniqueWithoutOrganizationInputObjectSchema), z.lazy(() => UserUpsertWithWhereUniqueWithoutOrganizationInputObjectSchema).array()]).optional(),
  createMany: z.lazy(() => UserCreateManyOrganizationInputEnvelopeObjectSchema).optional(),
