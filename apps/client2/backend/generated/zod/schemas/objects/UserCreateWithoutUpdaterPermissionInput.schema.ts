...
export const UserCreateWithoutUpdaterPermissionInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterPermissionInput, Prisma.UserCreateWithoutUpdaterPermissionInput> = z.object({
...
export const UserCreateWithoutUpdaterPermissionInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
