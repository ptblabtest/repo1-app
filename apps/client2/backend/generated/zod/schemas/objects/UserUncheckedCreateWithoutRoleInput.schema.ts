...
export const UserUncheckedCreateWithoutRoleInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutRoleInput, Prisma.UserUncheckedCreateWithoutRoleInput> = z.object({
...
export const UserUncheckedCreateWithoutRoleInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
