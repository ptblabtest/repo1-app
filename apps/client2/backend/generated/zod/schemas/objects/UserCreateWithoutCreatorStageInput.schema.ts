...
export const UserCreateWithoutCreatorStageInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorStageInput, Prisma.UserCreateWithoutCreatorStageInput> = z.object({
...
export const UserCreateWithoutCreatorStageInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
