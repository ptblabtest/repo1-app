...
export const ProfileUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema: z.ZodType<Prisma.ProfileUncheckedUpdateManyWithoutCreatedByNestedInput, Prisma.ProfileUncheckedUpdateManyWithoutCreatedByNestedInput> = z.object({
  ...
  upsert: z.union([z.lazy(() => ProfileUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => ProfileUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => ProfileUpdateManyWithWhereWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileUpdateManyWithWhereWithoutCreatedByInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => ProfileScalarWhereInputObjectSchema), z.lazy(() => ProfileScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const ProfileUncheckedUpdateManyWithoutCreatedByNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => ProfileCreateWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileCreateWithoutCreatedByInputObjectSchema).array(), z.lazy(() => ProfileUncheckedCreateWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileUncheckedCreateWithoutCreatedByInputObjectSchema).array()]).optional(),
  connectOrCreate: z.union([z.lazy(() => ProfileCreateOrConnectWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileCreateOrConnectWithoutCreatedByInputObjectSchema).array()]).optional(),
  upsert: z.union([z.lazy(() => ProfileUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema), z.lazy(() => ProfileUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema).array()]).optional(),
  createMany: z.lazy(() => ProfileCreateManyCreatedByInputEnvelopeObjectSchema).optional(),
