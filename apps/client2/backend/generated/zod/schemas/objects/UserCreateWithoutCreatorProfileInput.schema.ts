...
export const UserCreateWithoutCreatorProfileInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorProfileInput, Prisma.UserCreateWithoutCreatorProfileInput> = z.object({
...
export const UserCreateWithoutCreatorProfileInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
