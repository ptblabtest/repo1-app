...
export const UserCreateWithoutCreatorNoteInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorNoteInput, Prisma.UserCreateWithoutCreatorNoteInput> = z.object({
...
export const UserCreateWithoutCreatorNoteInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
