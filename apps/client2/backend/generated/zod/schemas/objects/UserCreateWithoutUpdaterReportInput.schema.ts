...
export const UserCreateWithoutUpdaterReportInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterReportInput, Prisma.UserCreateWithoutUpdaterReportInput> = z.object({
...
export const UserCreateWithoutUpdaterReportInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
