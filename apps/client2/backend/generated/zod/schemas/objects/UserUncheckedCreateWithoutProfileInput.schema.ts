...
export const UserUncheckedCreateWithoutProfileInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutProfileInput, Prisma.UserUncheckedCreateWithoutProfileInput> = z.object({
...
export const UserUncheckedCreateWithoutProfileInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
