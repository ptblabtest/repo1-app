...
export const UserCreateWithoutPermissionsInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutPermissionsInput, Prisma.UserCreateWithoutPermissionsInput> = z.object({
...
export const UserCreateWithoutPermissionsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
