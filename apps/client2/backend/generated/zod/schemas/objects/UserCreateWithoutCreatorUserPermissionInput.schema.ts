...
export const UserCreateWithoutCreatorUserPermissionInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorUserPermissionInput, Prisma.UserCreateWithoutCreatorUserPermissionInput> = z.object({
...
export const UserCreateWithoutCreatorUserPermissionInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
