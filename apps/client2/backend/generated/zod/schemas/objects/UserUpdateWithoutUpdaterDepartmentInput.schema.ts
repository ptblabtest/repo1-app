...
export const UserUpdateWithoutUpdaterDepartmentInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutUpdaterDepartmentInput, Prisma.UserUpdateWithoutUpdaterDepartmentInput> = z.object({
...
export const UserUpdateWithoutUpdaterDepartmentInputObjectZodSchema = z.object({
  username: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  password: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  status: z.union([UserStatusSchema, z.lazy(() => EnumUserStatusFieldUpdateOperationsInputObjectSchema)]).optional(),
  department: z.lazy(() => DepartmentUpdateOneWithoutUsersNestedInputObjectSchema).optional(),
