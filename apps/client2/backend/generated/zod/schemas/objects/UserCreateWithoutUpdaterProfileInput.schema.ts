...
export const UserCreateWithoutUpdaterProfileInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterProfileInput, Prisma.UserCreateWithoutUpdaterProfileInput> = z.object({
...
export const UserCreateWithoutUpdaterProfileInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
