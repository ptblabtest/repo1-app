...
export const NoteUncheckedUpdateWithoutCreatedByInputObjectSchema: z.ZodType<Prisma.NoteUncheckedUpdateWithoutCreatedByInput, Prisma.NoteUncheckedUpdateWithoutCreatedByInput> = z.object({
...
export const NoteUncheckedUpdateWithoutCreatedByInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
  createdAt: z.union([z.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).nullish(),
  updatedAt: z.union([z.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).nullish(),
