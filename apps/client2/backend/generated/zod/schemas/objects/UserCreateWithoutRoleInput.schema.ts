...
export const UserCreateWithoutRoleInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutRoleInput, Prisma.UserCreateWithoutRoleInput> = z.object({
...
export const UserCreateWithoutRoleInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
