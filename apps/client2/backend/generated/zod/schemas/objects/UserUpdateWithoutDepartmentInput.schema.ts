...
export const UserUpdateWithoutDepartmentInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutDepartmentInput, Prisma.UserUpdateWithoutDepartmentInput> = z.object({
...
export const UserUpdateWithoutDepartmentInputObjectZodSchema = z.object({
  username: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  password: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  status: z.union([UserStatusSchema, z.lazy(() => EnumUserStatusFieldUpdateOperationsInputObjectSchema)]).optional(),
  organization: z.lazy(() => OrganizationUpdateOneWithoutUsersNestedInputObjectSchema).optional(),
