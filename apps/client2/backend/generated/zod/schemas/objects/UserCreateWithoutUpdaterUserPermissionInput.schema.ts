...
export const UserCreateWithoutUpdaterUserPermissionInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterUserPermissionInput, Prisma.UserCreateWithoutUpdaterUserPermissionInput> = z.object({
...
export const UserCreateWithoutUpdaterUserPermissionInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
