...
export const UserCreateWithoutCreatorReportInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorReportInput, Prisma.UserCreateWithoutCreatorReportInput> = z.object({
...
export const UserCreateWithoutCreatorReportInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
