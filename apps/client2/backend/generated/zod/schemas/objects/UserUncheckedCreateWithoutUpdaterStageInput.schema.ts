...
export const UserUncheckedCreateWithoutUpdaterStageInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutUpdaterStageInput, Prisma.UserUncheckedCreateWithoutUpdaterStageInput> = z.object({
...
export const UserUncheckedCreateWithoutUpdaterStageInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
