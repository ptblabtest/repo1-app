...
export const UserCreateWithoutCreatorDepartmentInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCreatorDepartmentInput, Prisma.UserCreateWithoutCreatorDepartmentInput> = z.object({
...
export const UserCreateWithoutCreatorDepartmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
