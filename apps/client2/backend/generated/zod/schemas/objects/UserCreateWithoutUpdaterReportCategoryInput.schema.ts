...
export const UserCreateWithoutUpdaterReportCategoryInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterReportCategoryInput, Prisma.UserCreateWithoutUpdaterReportCategoryInput> = z.object({
...
export const UserCreateWithoutUpdaterReportCategoryInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
