...
export const UserCreateWithoutUpdaterStageInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutUpdaterStageInput, Prisma.UserCreateWithoutUpdaterStageInput> = z.object({
...
export const UserCreateWithoutUpdaterStageInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
