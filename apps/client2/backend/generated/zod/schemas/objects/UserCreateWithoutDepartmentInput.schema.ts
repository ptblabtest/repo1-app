...
export const UserCreateWithoutDepartmentInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutDepartmentInput, Prisma.UserCreateWithoutDepartmentInput> = z.object({
...
export const UserCreateWithoutDepartmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
