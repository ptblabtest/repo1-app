...
export const UserUncheckedCreateWithoutDepartmentInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutDepartmentInput, Prisma.UserUncheckedCreateWithoutDepartmentInput> = z.object({
...
export const UserUncheckedCreateWithoutDepartmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
