...
export const UserUncheckedCreateWithoutUpdaterNoteInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutUpdaterNoteInput, Prisma.UserUncheckedCreateWithoutUpdaterNoteInput> = z.object({
...
export const UserUncheckedCreateWithoutUpdaterNoteInputObjectZodSchema = z.object({
  id: z.string().optional(),
  username: z.string(),
  password: z.string(),
  status: UserStatusSchema.optional(),
