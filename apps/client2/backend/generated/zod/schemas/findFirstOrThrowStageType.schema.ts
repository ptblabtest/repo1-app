...
export const StageTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StageTypeSelect, Prisma.StageTypeSelect> = z.object({
...
export const StageTypeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    model: z.boolean().optional(),
    order: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const StageTypeFindFirstOrThrowSchema: z.ZodType<Prisma.StageTypeFindFirstOrThrowArgs, Prisma.StageTypeFindFirstOrThrowArgs> = z.object({ select: StageTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StageTypeIncludeObjectSchema.optional()), orderBy: z.union([StageTypeOrderByWithRelationInputObjectSchema, StageTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: StageTypeWhereInputObjectSchema.optional(), cursor: StageTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StageTypeScalarFieldEnumSchema, StageTypeScalarFieldEnumSchema.array()]).optional() }).strict();

export const StageTypeFindFirstOrThrowZodSchema = z.object({ select: StageTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StageTypeIncludeObjectSchema.optional()), orderBy: z.union([StageTypeOrderByWithRelationInputObjectSchema, StageTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: StageTypeWhereInputObjectSchema.optional(), cursor: StageTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StageTypeScalarFieldEnumSchema, StageTypeScalarFieldEnumSchema.array()]).optional() }).strict();