...
export const ProfileUpdateOneSchema = z.object({ select: ProfileSelectObjectSchema.optional(), include: ProfileIncludeObjectSchema.optional(), data: z.union([ProfileUpdateInputObjectSchema, ProfileUncheckedUpdateInputObjectSchema]), where: ProfileWhereUniqueInputObjectSchema  })