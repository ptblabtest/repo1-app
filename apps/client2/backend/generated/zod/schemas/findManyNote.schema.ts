...
export const NoteFindManySelectSchema: z.ZodType<Prisma.NoteSelect, Prisma.NoteSelect> = z.object({
...
export const NoteFindManySchema: z.ZodType<Prisma.NoteFindManyArgs, Prisma.NoteFindManyArgs> = z.object({ select: NoteFindManySelectSchema.optional(), include: z.lazy(() => NoteIncludeObjectSchema.optional()), orderBy: z.union([NoteOrderByWithRelationInputObjectSchema, NoteOrderByWithRelationInputObjectSchema.array()]).optional(), where: NoteWhereInputObjectSchema.optional(), cursor: NoteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NoteScalarFieldEnumSchema, NoteScalarFieldEnumSchema.array()]).optional() }).strict();
