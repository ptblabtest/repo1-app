...
export const DepartmentPermissionFindUniqueOrThrowSchema = z.object({ select: DepartmentPermissionSelectObjectSchema.optional(), include: DepartmentPermissionIncludeObjectSchema.optional(), where: DepartmentPermissionWhereUniqueInputObjectSchema })