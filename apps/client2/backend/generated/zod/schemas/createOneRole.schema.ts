...
export const RoleCreateOneSchema = z.object({ select: RoleSelectObjectSchema.optional(), include: RoleIncludeObjectSchema.optional(), data: z.union([RoleCreateInputObjectSchema, RoleUncheckedCreateInputObjectSchema])  })