...
export const UserPermissionFindUniqueSchema = z.object({ select: UserPermissionSelectObjectSchema.optional(), include: UserPermissionIncludeObjectSchema.optional(), where: UserPermissionWhereUniqueInputObjectSchema })