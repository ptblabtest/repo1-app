...
export const DepartmentPermissionDeleteOneSchema = z.object({ select: DepartmentPermissionSelectObjectSchema.optional(), include: DepartmentPermissionIncludeObjectSchema.optional(), where: DepartmentPermissionWhereUniqueInputObjectSchema  })